...
func (a *App) retrieveAllTableRecords(w http.ResponseWriter, r *http.Request) {
	...
	vars := mux.Vars(r)
	id := vars["id"]
	res, err := httpclient.RetrieveAllTableRecords(id, a.Cfg.GetUsername(), a.Cfg.GetPassword(), r.URL.Query())
	if err != nil {
...
func (a *App) createTableRecords(w http.ResponseWriter, r *http.Request) {
	...
	res, err := httpclient.CreateTableRecords(id, a.Cfg.GetUsername(), a.Cfg.GetPassword(), bodyBytes, r.URL.Query())
	if err != nil {
...
// @Param id path string true "Enter id"
// @Success 200
// @Router /table/{tableName}/{sys_id} [get]
func (a *App) retrieveSingleTableRecord(w http.ResponseWriter, r *http.Request) {
	...
	vars := mux.Vars(r)
	id := vars["id"]
	res, err := httpclient.RetrieveSingleTableRecord(id, a.Cfg.GetUsername(), a.Cfg.GetPassword(), r.URL.Query())
	if err != nil {
...
// @Param id path string true "Enter id"
// @Success 200
// @Router /table/{tableName}/{sys_id} [put]
func (a *App) modifyTableRecord(w http.ResponseWriter, r *http.Request) {
	...
	res, err := httpclient.ModifyTableRecord(id, a.Cfg.GetUsername(), a.Cfg.GetPassword(), bodyBytes, r.URL.Query())
	if err != nil {
...
// @Param id path string true "Enter id"
// @Success 200
// @Router /table/{tableName}/{sys_id} [delete]
func (a *App) deleteTableRecord(w http.ResponseWriter, r *http.Request) {
	...
	vars := mux.Vars(r)
	id := vars["id"]
	res, err := httpclient.DeleteTableRecord(id, a.Cfg.GetUsername(), a.Cfg.GetPassword(), r.URL.Query())
	if err != nil {
